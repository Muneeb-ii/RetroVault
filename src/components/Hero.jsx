          ...
          <div className="window-body">
            <div className="text-center">
              ...
              <div className="mb-6">
                ...
                <div className="text-2xl font-bold text-blue-600 mb-4">RetroVault</div>
              </div>
              
              {/* Main Headline */}
              <h1 className="text-4xl md:text-6xl font-bold text-gray-800 mb-6 leading-tight">
                Rewind your finances.<br />
                <span className="text-blue-600">Fast-forward your future.</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
                <button
                  ...
                  className="retro-button px-8 py-4 text-lg font-bold text-white bg-blue-600 hover:bg-blue-700 transition-colors"
                >
                  🚀 Start Your Journey
                </button>
                ...
                <a 
                  href="#features" 
                  className="retro-button px-8 py-4 text-lg font-bold text-gray-700 bg-gray-200 hover:bg-gray-300 transition-colors"
                >
                  📊 Explore Features
                </a>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
                <div className="retro-info text-center p-4">
